...
Route::middleware(['auth', 'ensure.active.role', 'active.role:host'])
    ...
    ->group(function () {
        ...
        Route::get('facility-memories/create', [FacilityMemoryController::class, 'create'])->name('facility-memories.create');
        Route::post('facility-memories', [FacilityMemoryController::class, 'store'])->name('facility-memories.store');
