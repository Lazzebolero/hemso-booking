...
class RestaurantBoardController extends Controller
{
    ...
    {
        return view('admin.restaurant-board.index', $this->boardData());
    }
    ...
    {
        return $this->buildBoardData();
    }

    public function kiosk(): View
    {
        return view('admin.restaurant-board.kiosk', $this->boardData());
    }
    ...
    protected function buildBoardData(): array
    {
        ...
        $todayTours = Tour::with($this->tourCoGuideService->tourDisplayRelations())
            ->whereDate('tour_date', $today)
