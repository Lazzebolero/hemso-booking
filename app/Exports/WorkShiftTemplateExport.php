...
class WorkShiftTemplateInstructionsSheet implements FromArray, ShouldAutoSize, WithTitle
{
    ...
    public function array(): array
    {
        ...
        return [
            ...
            ['Tom tid = jobbar inte, även om rollen står kvar. Vid ny uppladdning får du frågan om du vill ta bort ett redan sparat pass.'],
            ['På kök räcker station (t.ex. Kassa) — standardtiden från Restaurangfunktioner används. Guide, värd, admin och trainee har egna standardtider där.'],
