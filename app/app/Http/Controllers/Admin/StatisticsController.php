...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
        <h2 class="mb-1">Utökad statistik</h2>
        <div class="muted">Välj dag, vecka, månad eller år och se bokningsläge, beläggning och jämförelser.</div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="page-card h-100">
            ...
            @php
                ...
                $change = $previousBooked > 0
                    ? round((($currentBooked - $previousBooked) / $previousBooked) * 100)
                    : 0;
            @endphp
